...
As you can see, the size of the cells depends on the length of the names of the gifts and the quantities, although they will at least have to be the space of the titles <code>Gift</code> and <code>Quantity</code> respectively.

The table uses the symbols: <code>+</code> for the top border, <code>*</code> for the bottom border, <code>-</code> for the horizontal lines and <code>|</code> for the vertical lines.
