...
As you can see, the cube has three faces visually. The symbols used to build the cube faces are: <code>/</code>, <code>\</code>, <code>_</code>. In order to make the cube, some spaces are needed. Also, each line is separated by a new line character <code>\n</code>.
