...
Each box represents its measures with an object. For example: <code>{l: 2, w: 3, h: 2}</code>. This means that the box has a length of 2, a width of 3 and a height of 2.
